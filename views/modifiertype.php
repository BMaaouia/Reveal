...
<?php
    ...
    if (
        ...
        if (
            ...
            $typeCore->modifiertype($type, $_POST["id"]);
...
<body>
		...
		<?php
			if (isset($_POST['id'])){
				$type = $typeCore->recuperer($_POST['id']);
				
		?>
      <div class="container mt-3">
<form action="" method="POST">
    <input type="hidden" name="id" value="<?php echo $type['id']; ?>">
    <h2 style="text-align:center"  > Modifier type</h2>
    <th>
    <div class="form-group">
      <label>Type</label>
      <input type="text" name="type" placeholder="Enter your type name" required minlength="4" class="form-control" value="<?php echo $type['type']; ?>">
    </div>
    </th>  
    ...
    <div class="form-group">
      <label>contenu</label>
      <input type="text" name="contenu" placeholder="Enter your type contenu"required minlength="4" class="form-control" value="<?php echo $type['contenu']; ?>">
    </div>
    </th>
