...
<?php
    ...
    if (
        ...
        if (
            ...
            $EventCore->modifierevent($event, $_POST["id"]);
...
<body>
		...
		<?php
			if (isset($_POST['id'])){
				$event = $EventCore->recuperer($_POST['id']);
...
<form action="" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" name="titre" placeholder="Enter your event name"required minlength="4" class="form-control" value="<?php echo $event['titre']; ?>">
    </div>
    </th>  
    ...
    <div class="form-group">
      ...
      <input type="text" name="description" placeholder="Enter your event description"required minlength="4" class="form-control" value="<?php echo $event['description']; ?>">
    </div>
    </th>
    <div class="form-group">
      <label>Date</label>
      <input type="date" name="date" placeholder="Enter your event date"required minlength="4" class="form-control" value="<?php echo $event['date']; ?>">
    </div>
    </th>
    <div class="form-group">
      <label>lieu</label>
      <input type="text" name="lieu" placeholder="Enter your event location"required minlength="4" class="form-control" value="<?php echo $event['lieu']; ?>">
    </div>
    </th>
