    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <h1><a href="#body"><img src="assetsFarouk/asdf.png" alt="" title="" /></a></h1>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                ...
                <li>
                    ...
                    <li>
                        <a  href="affichercommande.php"><i class="fa fa-edit"></i> liste commande </a>
                        
                    </li>

                    <li>
                        <a class="active-menu" href="afficherpanier.php"><i class="fa fa-edit"></i> liste panier </a>
						...
						$a=1;
						 foreach($listepanier as $row){ ?>
							<tr>
								...
								<td class="action" data-title="Remove"><a href="supprimerpanier.php?id=<?php echo $row['idpan'];?>">supprimer <i class="ti-trash remove-icon"></i></a></td>
                                <td> <form method="POST" action="modifierpanier.php">
                               <button   type="submit"  class="btn btn-main text-center">Modifier Produit</button>
                            
						<input type="hidden" value=<?PHP echo $row['idpan']; ?> name="idpan">
					</form>
                </td>
							</tr>
