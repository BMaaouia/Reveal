<?php
	...
	if (
        ...
        isset($_POST["reponseR"]) && 
        isset($_POST["reponse"])
	){
		if (
            
            !empty($_POST["reponseR"]) &&
            !empty($_POST["reponse"])
        ) {
            $user = new reponse(
            ...
            $utilisateurC->modifierReponse($user, $_GET['idr']);
  ...
  <body>
    <div id="wrapper">
      ...
      <div id="page-wrapper">
          ...
          <div class="row">
            <div class="col-md-12">
              <h1 class="page-header">
                Modifier <small>Reponse</small>
              </h1>
            </div>
          </div>
          <!-- /. ROW  -->
          <button><a href="afficherreponseB.php">Retour à la liste</a></button>
        <hr>
		...
		<?php
			if (isset($_GET['idr'])){
				$user = $utilisateurC->recupererReponse($_GET['idr']);
		...
		<form action="" method="POST">
            <table class="table table-striped table-bordered table-hover" align="center" border="3">
                <tr>
                    ...
                    <td>
						<input type="text" name="idr" id="idr"  value = "<?php echo $user['idr']; ?>" disabled>
					</td>
				</tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="reponseR" id="reponseR" required minlength="2"   value = "<?php echo $user['reponseR']; ?>"></td>
                </tr>

				<tr>
                    <td>
                        <label for="prenom">Reponse:
                        </label>
                    </td>
                    <td><input type="text" name="reponse" id="reponse" required minlength="4" maxlength="100" value = "<?php echo $user['reponse']; ?>"></td>
                </tr>
