...
(function ($) {
  ...
  CRUMINA.headerSpacer = {
    ...
    init: function () {
      ...
      this.$spacer = jQuery('<div class="header--spacer"></div>').insertAfter(
        this.$header
      );
    },
    resize: function () {
          ...
          function () {
            ...
            current_cart
              ...
              .on("circle-animation-progress", function (event, progress) {
                current_cart
                  .find(".content")
                  .html(parseInt(counter * progress, 10) + "<span>%</span>");
              })
  ...
  CRUMINA.SeoScoreScrollAnnimation = function () {
    ...
    new ScrollMagic.Scene({ triggerElement: ".seo-score" })
      .setVelocity(
        ".seo-score .images img:last-child",
        { opacity: 1, bottom: "0" },
        1000
      )
      .triggerHook(0.8)
  ...
  CRUMINA.TestimonialScrollAnnimation = function () {
    ...
    new ScrollMagic.Scene({ triggerElement: ".testimonial-slider" })
      .setVelocity(
        ".testimonial-slider .testimonial__thumb-img",
        { opacity: 1, top: "-100" },
        600
      )
      .triggerHook(1)
  ...
  CRUMINA.MountainsScrollAnnimation = function () {
    ...
    new ScrollMagic.Scene({ triggerElement: ".background-mountains" })
      .setVelocity(
        ...
        { opacity: 1, bottom: "0", paddingBottom: "10%" },
        800
      )
      .triggerHook(0.4)
      .addTo(controller);
  ...
  CRUMINA.IsotopeSort = function () {
    ...
    $container.each(function () {
      var $current = $(this);
      var layout = $current.data("layout").length
        ? $current.data("layout")
        : "masonry";
      $current.isotope({
      ...
      swipers["swiper-" + index] = new Swiper(".swiper-" + index, {
        ...
        onSlideChangeStart: function (swiper) {
          if ($t.find(".slider-slides").length) {
            ...
            $t.find(".slider-slides .slides-item")
              .eq(realIndex)
