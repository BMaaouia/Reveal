<?php
$receiver = "allani.aziz01@gmail.com";
$subject = "Email Test via PHP using Localhost";
$body = "Please,recheck my REPORT!";
$sender = "From:ghofranesoltani29@gmail.com";
...
<body id="body">
  ...
  <!--==========================
    Intro Section
  ============================-->
  <button class="btn btn-warning"><a href="ajouterreclamation.php">Retour</a></button>
        ...
        <div class="container">
          <div class="section-header">
            <h2>Email sent successfully to admin</h2>
            <p>
