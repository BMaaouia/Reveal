      ...
      <div id="page-wrapper">
          ...
          <div class="row">
            <div class="col-md-12">
              <h1 class="page-header">
                Répondre <small>La Reclamation</small>
              </h1>
            </div>
          </div>
          <!-- /. ROW  -->
          <button class="btn btn-warning"><a href="afficherreclamation.php">Retour</a></button>
          <button class="btn btn-warning"><a href="afficherreponseB.php">Afficher les reponses</a></button>
        <hr>
        ...
        <form action="" method="POST">
            <table class="table table-striped table-bordered table-hover" border="1" align="center">
                ...
                <tr>
                    <td rowspan='3' colspan='1'>Cordonnés</td>
                    <td>
                        <label for="nom">id
                        </label>
                    </td>
                    <td><input type="text" name="idr" id="id"   disabled></td>
                </tr>
                <tr>
                    <td>
                        <label for="text">Etat
                    ...
                    <td><input type="text" name="reponseR" id="reponseR" required
       minlength="4" ></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="text" name="reponse" id="reponse" required
       minlength="4" ></td>
                </tr>
