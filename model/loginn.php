...
*/
		function __construct(int $userID ,string $firstName, string $lastName, string $email,  string $password , string $status, string $image , string $register_date ){
            $this->userID=$userID;
			$this->firstName=$firstName;
			$this->lastName=$lastName;
			$this->email=$email;
		...
		function getRegister_date(): string{
